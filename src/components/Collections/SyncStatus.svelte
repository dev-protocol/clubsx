...
<section class="max-h-[80vh] overflow-y-auto">
  <h2 class="mb-6 text-2xl">Publish Memberships/Collections on the blockchain</h2>
  <p class="mb-8">
    Memberships/Collections just created are not yet published on the blockchain. Submit all
