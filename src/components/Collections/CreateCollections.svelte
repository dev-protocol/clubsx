...
<form on:change|preventDefault={(e) => update(e)} class="w-full">
  ...
  <div class="w-full max-w-full">
    <!-- collection name -->
    <div class="mb-16 flex w-[52.2%] flex-col items-start justify-start gap-[7px]">
    ...
    <div class="mb-16 flex flex-col items-start gap-[7px] w-[479px] h-[294px]">
      <div class="flex items-start gap-[13px]">
        <span class="text-white text-base font-normal">Collection cover image</span>
        <span class="text-[#EB48F8] text-base font-normal uppercase"> * </span>
      </div>
      <label>
        <div class="flex p-2 flex-col items-start self-stretch rounded-[19px] border border-[#ffffff1a] bg-[#ffffff1a]">
          <div class="w-[463px] h-[216px] rounded-[12px] bg-[#040B10]">
          </div>
        </div>
        <input
      ...
      <span class="text-white text-base font-normal leading-6">Recommended image size is 2400 x 1200px</span>
    </div>

    <!-- start date -->
    <div class="mb-16 flex flex-col items-start w-[479px] gap-[7px]">
      <div class="flex items-start gap-[13px]">
        <span class="text-white text-base font-normal">Start date</span>
        <span class="text-[#EB48F8] text-base font-normal uppercase"> * </span>
      </div>
      <input
      type="datetime-local"
    ...
    <div class="mb-16 flex flex-col items-start w-[479px] gap-[7px]">
      <div class="flex items-start gap-[13px]">
        <span class="text-white text-base font-normal">End date</span>
        <span class="text-[#EB48F8] text-base font-normal uppercase"> * </span>
      </div>
      <input
      type="datetime-local"
