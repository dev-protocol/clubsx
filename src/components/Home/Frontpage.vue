      ...
      <div class="mx-auto max-w-sm">
        ...
        >
          ...
          <button
            ...
            class="rounded-full text-2xl w-full p-4 lg:p-8 font-bold bg-white text-black transition-all duration-300 outline outline-4 outline-transparent outline-offset-2 hover:outline-white"
          >
            {{ i18n('SignInOrSignUp') }}
          </button>
        </div>
