...
{#if !notFound || !props.item}
  ...
  >
    ...
    <div
      class="h-fit w-full max-w-full absolute left-0 right-0 top-0 hidden group-hover:flex flex-row items-center justify-end bg-surface-300 rounded-md p-4 gap-4"
    >
      <button
